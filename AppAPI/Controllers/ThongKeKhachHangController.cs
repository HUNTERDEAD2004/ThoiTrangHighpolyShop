...
namespace AppAPI.Controllers
{
    ...
    public class ThongKeKhachHangController : ControllerBase
    {
        ...
        // Removed: KhachHangCuTheoNgay (method not in service interface)

        // Removed: KhachHangCuTheoThang (method not in service interface)

        // Removed: KhachHangCuTheoNam (method not in service interface)
        ...
        [HttpGet("Tong-Khach-thang/{month}/{year}")]
