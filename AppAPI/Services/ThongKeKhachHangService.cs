...
namespace AppAPI.Services
{
    public class ThongKeKhachHangService : IThongKeKhachHangService
    {
        ...
        //{
        //    var khachHangCu = context.KhachHangs.Count(kh => kh.LichSuTichDiems.Any(ls => ls.KhachHang.MaKhachHang == kh.MaKhachHang && ls.HoaDon.NgayTao.Date == date.Date ));
        //    return khachHangCu;
        //}

        //public int KhachHangCuTheoThang(int month, int year)
        //{
        //    var kh = context.KhachHangs.Count(kh => kh.LichSuTichDiems.Any(ls => ls.KhachHang.MaKhachHang == kh.MaKhachHang && ls.HoaDon.NgayTao.Month == month && ls.HoaDon.NgayTao.Year == year));
        //    return kh;
        //}
